...
@Component({
  selector: 'app-written-test-question',
  templateUrl: './written-test-question.component.html',
  styleUrls: ['./written-test-question.component.css']
})
export class WrittenTestQuestionComponent implements OnInit {
